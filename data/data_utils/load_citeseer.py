...
def get_raw_text_citeseer(use_text=False, seed=0):
    if osp.exists(f"./datasets/citeseer/citeseer_random_sbert.pt"):
        data = torch.load(f"./datasets/citeseer/citeseer_random_sbert.pt", map_location='cpu')
        ...
        # with open('./datasets/citeseer_text.json', 'w', encoding='utf-8') as f:
