...
# return cora datasets as pytorch geometric Data object together with 60/20/20 split, and list of cora IDs
...
def get_raw_text_cora(use_text=False, seed=0):
    ...
    text = []
    print("data_citeid:", len(data_citeid))
    ...
    # with open('./datasets/cora_new_text.json', 'w', encoding='utf-8') as f:
