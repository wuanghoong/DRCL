...
parser.add_argument("-SLF", "--self_loop_false", dest="adj_loop", default=None, action="store_false",
                    help="Whether the adj has self-loop, default is True. Using '-SLF' to load adj without self-loop.")
parser.add_argument("-SF", "--symmetric_false", dest="adj_symmetric", default=None, action="store_false",
...
# parser.add_argument("-M", "--model", type=str, dest="model_name", default="GCSEE",
#                     help="The model you want to run.")
parser.add_argument("-D", '--datasets', type=str, dest="dataset_name", default="acm",
